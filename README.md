...
<p>В терминах MVP(Model-View-Presenter) цепочки действий в проекте можно описать так:<br> V --> P --> M --> P --> V То есть, цепочка начинается, когда происходит событие, привязанное к какому-то визуальному элементу на экране. </p>
